...
import './ManagePasswordPage.css';
import Back from './assets/back.svg';
import ManagePasswordHeader from './assets/manage-password-header.svg';
  ...
  return (
    <>
      <div className='container'>
        <img
          className='manage-password-header'
          src={ManagePasswordHeader}
          alt='header'
        />
        <div className='top'>
